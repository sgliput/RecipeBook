    ...
    componentDidUpdate(prevProps) {
        ...
        if (this.props.show !== prevProps.show) {
            if (this.props.show === "block") {
                ...
                //Function for rendering pie chart on home page
                ...
                API.getPrivateTagProportions(sessionStorage.getItem("userID"))
                .then(res => {
                    console.log(res.data);
                    ...
                    var myChart = new Chart(ctx, {
                        ...
                        options: {
                            ...
                            title: {
                                display: true,
                                position: "top",
                                text: "These are the tags you use most!",
                                fontSize: 18,
                                fontColor: "#111"
                            },
                            legend: {
