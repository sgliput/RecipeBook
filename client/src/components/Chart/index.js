...
class TagChart extends Component {
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            backgroundColor: [
                                ...
                                'rgba(154, 22, 235, 0.2)',
                                'rgba(55, 88, 111, 0.2)',
                                'rgba(205, 132, 102, 0.2)',
                                'rgba(223, 142, 155, 0.2)',
                                'rgba(195, 139, 4, 0.2)',
                                ...
                                'rgba(255, 123, 144, 0.2)',

                                'rgba(5, 83, 132, 0.2)',
                                'rgba(234, 182, 65, 0.2)',
                                'rgba(245, 106, 126, 0.2)',

                                // 'rgba(76, 222, 42, 0.2)',
                                // 'rgba(183, 202, 255, 0.2)',
                                // 'rgba(255, 19, 94, 0.2)',

                                // 'rgba(252, 189, 22, 0.2)',
                                // 'rgba(104, 162, 135, 0.2)',
                                // 'rgba(255, 77, 86, 0.2)',
                                // 'rgba(75, 192, 192, 0.2)',
                                // 'rgba(153, 102, 255, 0.2)'
                    ...
                    options: {
                        ...
                        title: {
                            display: true,
                            position: "top",
                            text: "What are the most popular tags?",
                            fontSize: 18,
                            fontColor: "#111"
                        },
                        legend: {
    ...
    render() {
        return (
            <div>
                <canvas id="myChart" width="60%" height="800"></canvas>
                <script>
